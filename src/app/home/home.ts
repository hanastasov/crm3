...
export default class Home extends LitElement {
  ...
  @property()
  private cRMAppDataMeetingsTasks?: any[];
      ...
      <div class="row-layout group">
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item: any) => html`
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar src="/src/assets/Account-List-Avatar-Icon.svg" class="avatar"></igc-avatar>
                    </div>
                    <div>
            ...
            <div class="column-layout group_6">
              <igc-list class="list">
                ${this.northwindCustomers?.map((item: any) => html`
                  <igc-list-item>
                    <div slot="start">
                      <igc-avatar src="/src/assets/Contacts-List-Avatar-Icon.svg" class="avatar"></igc-avatar>
                    </div>
                    <div>
                      <div class="column-layout group_7">
        ...
        <div class="column-layout group_4">
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item: any) => html`
                <igc-list-item>
                  <div slot="start">
                    <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" class="avatar avatar_1"></igc-avatar>
                  </div>
                  <div>
                    <div class="column-layout group_7">
          ...
          <div class="column-layout group_3">
            ...
            <igc-list class="list">
              ${this.cRMAppDataMeetingsTasks?.map((item: any) => html`
                <igc-list-item>
                  <div slot="start">
                    <igc-avatar src="/src/assets/Tasks-Avatar-Icon.svg" class="avatar avatar_2"></igc-avatar>
                  </div>
                  <div>
                    <div class="column-layout group_7">
