...
export default class Accounts extends LitElement {
  ...
  render() {
    return html`
          ...
          <div class="column-layout group_2">
            ...
            <div class="row-layout filters-and-sorting">
              <div class="row-layout group_4">
                <igc-select ?outlined="${false}" value="2" class="select">
      ...
      <igc-dialog ?close-on-outside-click="${true}" ?close-on-escape="${true}" id="new-account-dialog">
            ...
            <div class="column-layout group_8">
              ...
              <div class="row-layout group_9">
                <div class="column-layout group_10">
                  ...
                  <igc-select ?outlined="${false}" label="Type" value="1" class="user-input">
                ...
                <div class="column-layout group_10">
                  ...
                  <igc-select ?outlined="${false}" label="Industry" value="1" class="user-input">
                    <igc-select-item value="1" ?selected="${true}">
                      -- None --
                    </igc-select-item>
                    <igc-select-item value="2">
