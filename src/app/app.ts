        ...
        <igc-nav-drawer ?open="${true}" position="relative" id="nav-drawer" class="nav-drawer">
          <igc-list class="list">
            <igc-list-item @click="${() => Router.go('/home')}">
              <div slot="start">
                <igc-avatar src="/src/assets/Home-Avatar-Icon.svg" shape="circle" class="avatar"></igc-avatar>
              </div>
              <div slot="title">Home</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/accounts')}">
              <div slot="start">
                <igc-avatar src="/src/assets/Accounts-Avatar-Icon.svg" shape="circle" class="avatar"></igc-avatar>
              </div>
            ...
            <igc-list-item @click="${() => Router.go('/reports')}">
              <div slot="start">
                <igc-avatar src="/src/assets/Reports-Avatar-Icon.svg" shape="circle" class="avatar"></igc-avatar>
              </div>
              <div slot="title">Reports</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/calendar')}">
              <div slot="start">
                <igc-avatar src="/src/assets/Calendar-Avatar-Icon.svg" shape="circle" class="avatar"></igc-avatar>
              </div>
              <div slot="title">Calendar</div>
            </igc-list-item>
            <igc-list-item @click="${() => Router.go('/tasks')}">
              <div slot="start">
                <igc-avatar src="/src/assets/Tasks-Avatar-Icon.svg" shape="circle" class="avatar"></igc-avatar>
              </div>
